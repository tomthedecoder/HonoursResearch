...
def no_forcing(num_nodes, num_inputs):
    """ mask of 0's for no forcing terms"""

    return general_make_mask(num_nodes, num_inputs, lambda i, num_nodes: False)
...
class NetworkStructure:
    """ A template for a network's structure, which the environment class uses to fill the population"""

    distribution: Distribution
    num_nodes: int
    forcing_mask_type: str
